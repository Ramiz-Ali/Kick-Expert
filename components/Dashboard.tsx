                    ...
                    <div className="flex justify-center items-center mb-6">
                        <div className="flex space-x-2">
                            <button
                                ...
                                className={`px-4 py-2 rounded-full flex items-center transition-colors ${activeTab === 'wallet'
                            ...
                            <button
                                ...
                                className={`px-4 py-2 rounded-full flex items-center transition-colors ${activeTab === 'history'
                                        ? 'bg-lime-400 text-white'
                                        : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`px-4 py-2 rounded-full flex items-center transition-colors relative ${activeTab === 'notifications'
                                        ? 'bg-lime-400 text-white'
                                        : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`px-4 py-2 rounded-full flex items-center transition-colors ${activeTab === 'support'
                                        ? 'bg-lime-400 text-white'
                                        : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                                    }`}
                            >
