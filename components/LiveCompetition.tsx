...
export default function LiveCompetition() {
    return (
        <div className="w-full flex items-center justify-center pb-10 md:pb-20 bg-white">
            <div className="relative w-full md:w-[90%] pt-5 pb-5 bg-gray-900 text-white flex items-center justify-center flex-col text-center ">
                <div className="relative w-full">
                    ...
                    <div className="flex flex-col items-center text-center">
                        <div className="bg-lime-400 w-[50%] md:w-[20%] text-black font-bold cursor-pointer px-2 py-1 md:px-4 md:py-2 rounded-full text-xs md:text-base">LIVE COMPETITION</div>
                        <h1 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mt-3 md:mt-5">Think You Know Football?</h1>
                ...
                <div className="mt-5 md:mt-10 flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4 lg:space-x-36">
                    ...
                    <div className="flex items-center space-x-2 md:space-x-4 lg:space-x-34">
