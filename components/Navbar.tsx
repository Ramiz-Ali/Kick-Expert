...
import { FaSearch, FaBell, FaUser, FaUserCircle, FaCog, FaSignOutAlt } from 'react-icons/fa';
    ...
    <nav className="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-24 py-4">
      <div className="flex items-center">
       ...
       <div className="text-black border-l-2 p-5"></div> 
        <a href="#" className="text-gray-600 hover:text-gray-800 font-bold">Ask AI</a>
        <a href="#" className="text-gray-600 hover:text-gray-800 font-bold">Quiz</a>
        <button className="bg-lime-400 text-white px-4 py-2 rounded-full flex items-center shadow-lg">
          LIVE COMPETITION
          <span className="ml-2 bg-red-500 text-white text-xs px-2 py-1 rounded-full cursor-pointer">LIVE</span>
        </button></div>
        </div>
        ...
        <div className="relative">
          ...
          {dropdownOpen && (
            <div className="absolute z-50 right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg">
              <a href="#" className=" px-4 py-2 text-gray-700 hover:bg-gray-100 flex items-center">
